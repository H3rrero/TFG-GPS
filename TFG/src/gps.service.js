(function () {
    ...
    function EntidadesService() {
        ...
        service.hoverGraf = function (index) {
            ...
            var km = 0;
            for (let i = 0; i <= index; i++) {
                km += Number(service.tracks[service.trackActivo].puntos[i].distancia);

            }
            var position = ((km / 1000) / Number(service.tracks[service.trackActivo].distancia)) * 100;
            var arrow;
            ...
            console.log(service.tracks[service.trackActivo].distancia);
        ...
        service.cargarElevaciones = function (callback) {
            var elevaciones = [];
            var results2 = [];
            service.puntos = new Array();
        ...
        service.actualizarGrafAlturas = function (results2) {
